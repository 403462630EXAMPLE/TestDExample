...
public class SimpleMonthView2 extends View {
    private Map<String, Integer> marksMap = new HashMap<String, Integer>(); // 储存某个日子被标注
    ...
    public SimpleMonthView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SimpleMonthView2(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        MONTH_DAY_LABEL_TEXT_SIZE = MINI_DAY_NUMBER_TEXT_SIZE; //resources.getDimensionPixelSize(R.dimen.month_day_label_text_size);
        ...
        mRowHeight = (width - MONTH_HEADER_SIZE) / 7;//(int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, getResources().getDisplayMetrics());//(resources.getDimensionPixelOffset(R.dimen.date_picker_view_animator_height) - MONTH_HEADER_SIZE) / 6);
	...
	private void onDayClick(CalendarPagerAdapter.CalendarDay2 calendarDay) {
	...
	public CalendarPagerAdapter.CalendarDay2 getDayFromLocation(float x, float y) {
		...
		return new CalendarPagerAdapter.CalendarDay2(mYear, mMonth, day);
	}
...
//		drawMonthTitle(canvas);
	...
	public boolean onTouchEvent(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_UP) {
            CalendarPagerAdapter.CalendarDay2 calendarDay = getDayFromLocation(event.getX(), event.getY());
            if (calendarDay != null) {
	...
	public static abstract interface OnDayClickListener {
		public abstract void onDayClick(SimpleMonthView2 simpleMonthView, CalendarPagerAdapter.CalendarDay2 calendarDay);
	}
}