...
public class AlpSettings {
    ...
    public static class Security {
        ...
        public static void setFlag(Context context, String flag) {
            p(context).edit().putString(context.getString(R.string.alp_42447968_pkey_flag), flag)
                    .commit();
        }

        private static String getFlag(Context context) {
            return p(context).getString(context.getString(R.string.alp_42447968_pkey_flag), "");
        }

        private static String getKey(Context context, int resId) {
            return context.getString(resId) + "_" + getFlag(context);
        }
        ...
        public static boolean isAutoSavePattern(Context context) {
            return p(context).getBoolean(getKey(context, R.string.alp_42447968_pkey_sys_auto_save_pattern),
        ...
        public static void setAutoSavePattern(Context context, boolean v) {
            p(context).edit().putBoolean(getKey(context, R.string.alp_42447968_pkey_sys_auto_save_pattern), v)
                    .commit();
//            if (!v) setPattern(context, null);
        ...
        public static char[] getPattern(Context context) {
            String pattern = p(context).getString(getKey(context, R.string.alp_42447968_pkey_sys_pattern), null);
        ...
        public static void setPattern(Context context, char[] pattern) {
            p(context).edit().putString(getKey(context, R.string.alp_42447968_pkey_sys_pattern), pattern != null ?
        ...
        public static char[] getEncrypterClass(Context context) {
            String clazz = p(context).getString(getKey(context, R.string.alp_42447968_pkey_sys_encrypter_class),
                    null);
        ...
        public static void setEncrypterClass(Context context, char[] clazz) {
            p(context).edit().putString(getKey(context, R.string.alp_42447968_pkey_sys_encrypter_class),
