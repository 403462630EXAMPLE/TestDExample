...
public class LockPatternView extends View {
    ...
    private final float mDotSizeActivated;
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        defaultLineWidth = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2, getResources().getDisplayMetrics());
        float defaultDotSize = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 20, getResources().getDisplayMetrics());
        ...
        mSuccessColor = a.getColor(R.styleable.Alp_42447968_LockPatternView_successColor, Color.parseColor("#e9c135"));
        mRegularColor = a.getColor(R.styleable.Alp_42447968_LockPatternView_regularColor, Color.parseColor("#a5a2a0"));
        mErrorColor = a.getColor(R.styleable.Alp_42447968_LockPatternView_errorColor, Color.parseColor("#ff4f4f"));
        mActivatedColor = a.getColor(R.styleable.Alp_42447968_LockPatternView_activatedColor, mSuccessColor);
        mPathColor = a.getColor(R.styleable.Alp_42447968_LockPatternView_pathColor, mActivatedColor);
        mPathWidth = a.getDimension(R.styleable.Alp_42447968_LockPatternView_pathWidth, defaultLineWidth);
        mPathAlpha = a.getInteger(R.styleable.Alp_42447968_LockPatternView_pathAlpha, 255);
        ...
        mDotSize = a.getDimension(R.styleable.Alp_42447968_LockPatternView_dotSize, defaultDotSize);
        mDotSizeActivated = a.getDimension(R.styleable.Alp_42447968_LockPatternView_dotActivatedSize, mDotSize);

        circleRadius = a.getDimension(R.styleable.Alp_42447968_LockPatternView_circleRadius, mDotSize * 3 / 2);
        ...
        mCirclePaint.setColor(mRegularColor);
...
//        }
        ...
        if (partOfPattern) {
            ...
            canvas.drawCircle(centerX, centerY, mDotSizeActivated / 2, mPaint);

            mCirclePaint.setStrokeWidth(TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0.5f, getResources().getDisplayMetrics()));
            canvas.drawCircle(centerX, centerY, circleRadius - mPathWidth * 3 / 2, mCirclePaint);
        }
    }
