...
import cn.hdmoney.hdy.adapter.InvestmentRecordPageAdapter;
 ...
 */
public class InvestmentRecordActivity extends BaseActivity implements ViewPager.OnPageChangeListener{
    ...
    protected void initView() {
        ...
        InvestmentRecordPageAdapter adapter = new InvestmentRecordPageAdapter(getSupportFragmentManager());
