...
public class StepThreeFragment extends BaseFragment {
    ...
    protected int getContentView() {
        return R.layout.fragment_phone_step_three;
    }
    ...
    @OnClick({R.id.tv_get_code, R.id.tv_confirm_phone})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.tv_get_code:
                start();
                break;
            case R.id.tv_confirm_phone:
                confirmPhone();
                break;
        }
    }
    ...
    private void changeMobile() {
        progressDialog.show();
        subscription = ApiFactory.getHdyApi().changeMobile(10000, 2, "13028729112", "18828729113", etCode.getText().toString().trim(), "f33239446565d76c0e204f09b778caf2")
