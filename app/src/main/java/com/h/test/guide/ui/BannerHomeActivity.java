...
import cn.hdmoney.hdy.guide.banner.SimpleTextBanner;
import cn.hdmoney.hdy.guide.dialog.BannerDialog;
...
public class BannerHomeActivity extends Activity {
    ...
    private void sib_simple_usage() {
        SimpleImageBanner sib = (SimpleImageBanner)findViewById(R.id.sib_simple_usage1);
