...
import com.common.widget.viewpagerheader.R;
...
public class MainActivity extends FragmentActivity implements ScrollTabHolder, ViewPager.OnPageChangeListener {
    ...
    private void setTabsValue() {
        ...
        tabs.setSelectedTextColorResource(R.color.theme_color);
        //设置正常Tab文字的颜色 (这是我自定义的一个方法)
        tabs.setTextColorResource(R.color.demandtextcolor);
        // 点击Tab时的背景色
//        tabs.setTabBackground(R.color.color_white);
    }
