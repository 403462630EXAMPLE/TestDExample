...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    private OnPullListener mPullListener = new OnPullListener() {
        @Override
        public void onPulling(View headview) {
            TextView textView = (TextView) headview.findViewById(R.id.text_view);
            ImageView imageView = (ImageView) headview.findViewById(R.id.image_view);
            ProgressBar progressBar = (ProgressBar) headview.findViewById(R.id.pb_view);
...
//    private AnimationDrawable animationDrawable;
    ...
    private boolean mIsShowColorProgressBar = false;
//    private boolean mIsBootom = true;
    ...
    private void addDefaultHeadView(Context context) {
        mHeadView = LayoutInflater.from(context).inflate(R.layout.layout_head, this, false);
    ...
    private void ensureTarget() {
        ...
        if (mDistanceToTriggerSync == -1 || mDistanceToTriggerSync == 0) {
